...
cao = Namespace("http://purl.org/cao/")
...
editor = root.find('.//tei:respStmt/tei:name', ns)
editor_id = editor.get('ref').replace('#', '')
extraction_resp_uri = URIRef(ex + 'agent/' + editor_id) #agent uri
